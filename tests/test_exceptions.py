...
def test_invalid_nzb_error() -> None:
    ...
    assert InvalidNzbError._from_preset("groups") == InvalidNzbError(
    ...
    assert InvalidNzbError._from_preset("segments") == InvalidNzbError(
    ...
    assert InvalidNzbError._from_preset("file") == InvalidNzbError(
    ...
    assert not InvalidNzbError("blah") == object()
    assert hash(InvalidNzbError("blah")) == hash(InvalidNzbError("blah"))
